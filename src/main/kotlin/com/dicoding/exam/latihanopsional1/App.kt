...
fun sumOfBigThree(vararg numbers: Int): Int {
    val sortedNumbers = numbers.sortedDescending() //urutkan angka decending
    val bigThree = sortedNumbers.take(3) //ambil 3 angka terbesar
    val sumOfBigThree = bigThree.sum() //jumlah ketiganya
    return sumOfBigThree
}
