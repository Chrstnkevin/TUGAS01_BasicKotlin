...
fun minAndMax(number: Int): Int {
    val digits = number.toString().map { it.toString().toInt() } // Ubah angka menjadi list digit
    val sortedDigitsAsc = digits.sorted() // Urutkan angka dari terkecil ke terbesar
    val sortedDigitsDesc = digits.sortedDescending() // Urutkan angka dari terbesar ke terkecil
    val max = sortedDigitsDesc.first() // Ambil angka terbesar
    val min = sortedDigitsAsc.first() // Ambil angka terkecil
    return min + max // Jumlahkan minimum dan maksimum
}
